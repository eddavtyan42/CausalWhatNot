...
However, on discrete data, NOTEARS struggles.  On Alarm, it achieves $F_1 = 0.62$ and
SHD $= 62$; on Insurance, performance drops further to $F_1 = 0.41$ and SHD $= 79$.
...
a significant test result ($\chi^2 = 55.8$, $p = 5.4 \times 10^{-8}$), suggesting dependence where
